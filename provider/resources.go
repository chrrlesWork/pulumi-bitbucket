...
import (
	...
	"github.com/chrrlesWork/terraform-provider-bitbucket/v2/bitbucket"

	"github.com/chrrlesWork/pulumi-bitbucket/provider/pkg/version"
)
...
//go:embed cmd/pulumi-resource-bitbucket/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-bitbucket/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-bitbucket/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "bitbucket", bitbucket.Provider(),
		...
		// convention is to have a function at "github.com/iwahbe/terraform-provider-bitbucket/provider".New
		...
		//
		//nolint:lll
		P: shimv2.NewProvider(bitbucket.New(version.Version)()),
		...
		Keywords:   []string{"contineo", "bitbucket", "category/cloud"},
		License:    "Apache-2.0",
		Homepage:   "https://www.pulumi.com",
		Repository: "https://github.com/chrrlesWork/pulumi-bitbucket",
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: path.Join(
				"github.com/chrrlesWork/pulumi-bitbucket/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("bitbucket_", mainMod,
